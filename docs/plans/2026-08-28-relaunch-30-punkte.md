...
7. **Spieltag-Definition (statusbasiert):** Ein Spieltag ist **abgeschlossen**, wenn jedes seiner Spiele beendet oder verschoben (api-football-Status PST/CANC/TBD) ist; TBD nur, wenn sein Termin verstrichen ist — ein TBD-Spiel mit Termin heute oder später ist offen, nur die Anstoßzeit steht noch nicht fest (Issue #230). Er ist **laufend**, wenn mindestens ein Spiel beendet/live ist und mindestens ein nicht-verschobenes Spiel aussteht. Verschobene Spiele halten einen Spieltag nicht offen.
...
- **Abgeschlossener Spieltag** — Spieltag, dessen Spiele sämtlich beendet oder verschoben (PST/CANC/TBD) sind. TBD zählt nur mit verstrichenem Termin als verschoben (Issue #230).
