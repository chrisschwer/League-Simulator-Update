...
SaisonSimulieren <- function (Spielplan, ELOWerte,
  ...
  
{
  for (i in 1:AnzahlSpiele) 
  {
    ...
    # Tore übertragen
    Spielplan [i, 3] <- Ergebnis$ToreHeim
    Spielplan [i, 4] <- Ergebnis$ToreGast
    
    # Anpasen der ELO-Werte
    ELOWerte[TeamHeim] <- Ergebnis$ELOHeim
    ELOWerte[TeamGast] <- Ergebnis$ELOGast
