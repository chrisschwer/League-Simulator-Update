#' simulationsCPP_Liga3
#' 
#' CURRENTLY NOT USED SINCE NOT NECESSARY
#' 
...
#'   per team
#' @param Promotable vector containing Booleans wheter team may be promoted
#'   

simulationsCPP_Liga3 <- function (season, ELOValue,
